...
def get_chromosome_plasmids( input_fasta, chromosome_fasta, plasmid_fasta,  min_chrom_length):
    # read in the fasta
...
get_chromosome_plasmids(snakemake.input[0], snakemake.output[0], snakemake.output[1], snakemake.params[0])
