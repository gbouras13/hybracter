...
def get_quick_coverage_estimate(r1_seqkit, r2_seqkit, min_chrom_length, coverage_output_path):
    """
    takes seqkit input
    """
...
get_quick_coverage_estimate(
    snakemake.input.r1, snakemake.input.r2, snakemake.params.chromlen, snakemake.output.sr_coverage
)
