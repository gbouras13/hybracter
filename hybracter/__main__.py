...
@click.option('--min_length', 'min_length',  help='min read length for long reads', type=str,  default=1000)
@click.option('--min_quality', 'min_quality',  help='min read quality for long reads', type=str,  default=9)
